...
from app.settings import POSTGRES_SETTINGS
...
dialect = POSTGRES_SETTINGS.get("dialect")
user = POSTGRES_SETTINGS.get("user")
password = POSTGRES_SETTINGS.get("password")
host = POSTGRES_SETTINGS.get("host")
db_name = POSTGRES_SETTINGS.get("db_name")
port = '5432'

section = config.config_ini_section

config.set_section_option(section, "dialect", dialect)
